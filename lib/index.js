...
allAssets = ["qunit.css", "runner.html", "run-tests.js", "require.min.js", "qunit.js", "sinon.js"].map(function(asset) {
...
registration = function(mimosaConfig, register) {
  ...
  if (!mimosaConfig.testemQUnit.requireConfig) {
  ...
  if ((mimosaConfig.testemQUnit.executeDuringBuild && mimosaConfig.isBuild) || (mimosaConfig.testemQUnit.executeDuringWatch && mimosaConfig.isWatch)) {
    return testemSimple.registration(mimosaConfig, register);
  }
};

_buildRequireConfig = function(mimosaConfig, options, next) {
  var newRequireConfig, outputString, requireConfigString, specFilesString;
  requireConfig = mimosaConfig.testemQUnit.requireConfig ? mimosaConfig.testemQUnit.requireConfig : mimosaRequire.requireConfig();
...
__craftTestemConfig = function(mimosaConfig, currentTestemConfig) {
  ...
  return _.extend(currentTestemConfig, mimosaConfig.testemQUnit.testemConfig);
};
